...
const PropCard: React.FC<PropCardProps> = ({ icon, description }) => {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.7 }}
      className='bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out flex flex-col items-center px-4 py-6 md:p-6 gap-4 text-center relative z-20 justify-center w-full'
    >
